...
public class LandingRegionsProcessor {
    ...
    public LandingRegionsProcessor(ILandingRegionsDetector detector, ILandingRegionsElaborator elaborator) {
     ...
     * @param raceTrack the {@link RaceTrack} object where the processing takes place.
